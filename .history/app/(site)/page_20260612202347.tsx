...
export default async function Home() {
  ...
  <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2">
    <div>
      ...
      <h1 className="max-w-3xl text-5xl font-bold leading-tight text-[#3A2A2A] md:text-l7x [font-family:var(--font-playfair)]">
        Soft, elegant sweets for your sweetest moments.
      </h1>

      <p className="mt-6 max-w-xl text-lg leading-8 text-gray-600">
        Discover cakes, pastries and sweet creations made with care, soft colors,
