      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-3xl bg-white p-8 text-center shadow-sm">
            ...
            <h3 className="mt-4 text-xl font-bold text-[#2B1810]">
              Premium Quality
            </h3>
            <p className="mt-2 text-gray-600">
              Carefully selected ingredients for refined taste.
            </p>
          </div>
          ...
          <div className="rounded-3xl bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-2 text-gray-600">
              Cakes and sweets prepared for special occasions.
            </p>
          </div>
          ...
          <div className="rounded-3xl bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-2 text-gray-600">
              Build your order and continue the discussion on WhatsApp.
            </p>
          </div>
        </div>
      </section>
